...
# Load data
bigdata_train <- read.csv("data/ST310_2024_bigdata_train.csv")
bigdata_test  <- read.csv("data/ST310_2024_bigdata_test.csv")
...
highdim_train <- read.csv("data/ST310_2024_highdim_train.csv")
highdim_test <- read.csv("data/ST310_2024_highdim_test.csv")
...
classify_train <- read.csv("data/ST310_2024_classify_train.csv")
classify_test <- read.csv("data/ST310_2024_classify_test.csv")
